...
private:
    ...
    void showNext(const unity::scopes::SearchReplyProxy &reply, unity::scopes::CategorisedResult res, int next_breadcrumb);
    void showPrevious(const unity::scopes::SearchReplyProxy &reply, unity::scopes::CategorisedResult res);
    void showTop(const unity::scopes::SearchReplyProxy &reply, unity::scopes::CategorisedResult res);
    void createButtons(const unity::scopes::SearchReplyProxy &reply);
